...
Train Tracks manages new applicants, trainees, and preceptors over a 10-year time period. Using Rails 4.0+ and Ruby 2.1.0+.
...
```
0 2 * * * source /etc/profile.d/rvm.sh && cd /var/www/traintracks && /usr/local/rvm/gems/ruby-2.1.0/bin/bundle exec rake seminar_reminder_email RAILS_ENV=production
```
...
Copyright (c) 2014 Remo Mueller. See [LICENSE](https://github.com/remomueller/training_grant/blob/master/LICENSE) for further details.
